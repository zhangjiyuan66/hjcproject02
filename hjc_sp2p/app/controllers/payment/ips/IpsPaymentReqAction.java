 ...
 *
 */
public class IpsPaymentReqAction extends PaymentBaseAction{
	
	private static IpsPaymentReqAction instance = null;
	
	private IpsPaymentReqAction(){
		
	}
	
	public static IpsPaymentReqAction getInstance(){
		if(instance == null){
			synchronized (IpsPaymentReqAction.class) {
				if(instance == null){
					instance = new IpsPaymentReqAction();
				}
			}
		}
